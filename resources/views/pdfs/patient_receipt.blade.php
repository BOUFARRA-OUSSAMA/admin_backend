...
<div class="container">
    <div class="header">
        <div class="clinic-name">Medical Practice {{ $doctorName }}</div>
        <div class="specialty">{{ $doctorSpecialty }}</div>
        <div class="contact-info">
            ☎ Phone: {{ $bill->doctor && $bill->doctor->phone ? $bill->doctor->phone : 'N/A' }} |
            ✉ Email: {{ $bill->doctor && $bill->doctor->email ? $bill->doctor->email : 'N/A' }}
        </div>
    ...
    <div class="section">
        ...
        <p><strong>Issue Date:</strong> {{ $bill->issue_date ? $bill->issue_date->format('d/m/Y') : 'N/A' }}</p>
    ...
    <div class="section">
        ...
        @if($bill->patient && $bill->patient->user && $bill->patient->user->email)
            <p><strong>Patient Email:</strong> {{ $bill->patient->user->email }}</p>
        @endif
    </div>
    ...
    <div class="total-section">
        <p>Total Amount: {{ number_format($bill->amount, 2, ',', ' ') }} MAD</p>
    </div>

    <div class="footer">
        <p>Thank you for your payment!</p>
        <p>&copy; {{ date('Y') }} Medical Practice {{ $doctorName }}. All rights reserved.</p>
    </div>
</div>
</body>
</html>
